...
namespace PurchaseOrder
{
	...
	public class OrderApplicationDataClass : System.ComponentModel.Component
	{
        ...
        private System.Data.SqlClient.SqlDataAdapter OrdersDataAdapter;
		/// <summary>
    ...
    "ProductName";
            ...
            // sqlSelectCommand2
            // 
            this.sqlSelectCommand2.CommandText = "SELECT * FROM Orders WHERE (EmployeeID = @EmployeeID) \r";
            ...
            // OrdersDataAdapter
            // 
            this.OrdersDataAdapter.DeleteCommand = this.sqlDeleteCommand1;
            this.OrdersDataAdapter.InsertCommand = this.sqlInsertCommand1;
            this.OrdersDataAdapter.SelectCommand = this.sqlSelectCommand2;
            ...
            this.OrdersDataAdapter.UpdateCommand = this.sqlUpdateCommand1;
            // 
            // sqlConnection1
            // 
            this.sqlConnection1.ConnectionString = "Data Source=(LocalDB)\\v11.0;AttachDbFilename=|DataDirectory|\\northwind.mdf;Integr" +
		...
		public void RefreshLocalData()
		{
			...
			try
			{
				if (MainModule.employeeID > 0)
				{
                    ...
                    //TODO 2: Assign the @EmployeeID paramter for the OrdersDataAdapter Select Command to the global employee
					...
					//TODO 3: Call the Fill method of OrdersDataAdapter 
					//to fill the Orders tables of the DataSet declared in TODO 1.
                    OrdersDataAdapter.Fill(tempDataSet);
                    OrderDetailsDataAdapter.Fill(tempDataSet);
					...
					//You can access this path by using Application.CommonAppDataPath. 
					//Concatenate the string returned by the CommonAppDataPath property with the name of the XML file, NorthwindData.XML
